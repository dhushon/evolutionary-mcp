...
const GroundingManager: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-hidden bg-bg-base">
      <div className="flex-none p-6 border-b border-border-base bg-bg-surface flex justify-between items-center shadow-sm z-10">
        <div>
        ...
        <button 
          ...
          className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-hover shadow-sm transition-all flex items-center space-x-2"
        >
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {rules?.map(rule => (
              <div key={rule.id} className="bg-bg-surface border border-border-base rounded-xl p-5 shadow-sm hover:shadow-md transition-all group h-fit">
                ...
                <p className="text-sm text-text-muted line-clamp-4 mb-4 leading-relaxed">
                  {rule.content}
                </p>
          ...
          <div className="bg-bg-surface w-full max-w-lg rounded-2xl shadow-xl border border-border-base animate-in zoom-in-95 duration-200">
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="rule-name" className="block text-sm font-medium text-text-base mb-1">Rule Name</label>
                  <input 
                    id="rule-name"
                    name="rule-name"
                    type="text"
                ...
                <div>
                  <label htmlFor="rule-content" className="block text-sm font-medium text-text-base mb-1">Content / Instruction</label>
                  <textarea 
                    id="rule-content"
                    name="rule-content"
                    required
                ...
                <div className="flex items-center space-x-2">
                  <input 
                    ...
                    className="rounded border-border-base text-primary focus:ring-primary h-4 w-4"
                  />
